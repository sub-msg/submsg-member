                	...
                	if("message" == g[1]){
                		...
                		d = "", $("#buy").find(".nodata").hide(), $.each(c.rc,
                                function(a, b) {
                			        var format = "yyyy年MM月dd日 HH点mm分ss秒";
                                    var e, c = "未知状态";
                                    0 == b.status ? c = '<a href="/member/pay.sm?orderId=' + b.orderId + '" style="color:#007ffc;">立即支付</a>': 1 == b.status && (c = "订单完成"),
                                    e = "未知状态",
